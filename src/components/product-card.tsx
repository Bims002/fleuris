    ...
    return (
        ...
        >
            ...
            <div className="p-6">
                ...
                <button className="w-full py-3 flex items-center justify-center gap-2 bg-gray-900 text-white rounded-xl font-medium hover:bg-purple-600 transition-colors active:scale-95">
                    <ShoppingBag size={18} />
                    Ajouter au panier
                </button>
            </div>
