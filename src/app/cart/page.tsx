    ...
    useEffect(() => {
        async function checkStock() {
            ...
            try {
                ...
                const result = await checkMultipleStockAvailability(cartItems)
                setStockWarnings(result.unavailableItems)
            } catch (error) {
                        ...
                        <>
                            ...
                            {stockWarnings.length > 0 && (
                                <div className="bg-orange-50 border border-orange-200 rounded-2xl p-4 mb-6 flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-orange-900 mb-1">Attention - Stock insuffisant</h3>
                                        <p className="text-sm text-orange-700">
                                            Les produits suivants ne sont plus disponibles en quantité suffisante : {stockWarnings.join(', ')}
                                        </p>
                                    </div>
                                </div>
                            )}
